...
conta = Conta(210800, "Roberto", 1000.0)
...
a = Conta(123, "Pedro", 55.0, 1000.0)
b = Conta(321, "Lucas", 100.0, 1000.0)
...
conta1 = Conta(123, "Carlos", 500.0)
conta2 = Conta(456, "Ana", 800.0)
