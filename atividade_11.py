...
class Conta:
    def __init__(self, numero, titular="Carlos Silva", saldo=0.0, limite=1000.0):
        self._numero = numero
...
if __name__ == '__main__':
    c = Conta('123-4', 'Patrícia Silva', 1000.0)
    cc = ContaCorrente('123-5', 'Roberto Silva', 1000.0)
    cp = ContaPoupanca('123-6', 'Fernanda Silva', 1000.0)
